...
export default function Navbar() {
    ...
    return (
        <>
            {isOpen && (
                <div className="fixed inset-1 bg-black/30 backdrop-blur-sm z-40" />
            )}
            ...
            <nav className={`bg-black w-[90vw] h-full flex items-center justify-center lg:hidden absolute z-50 rounded-xl ${isOpen ? `bottom-0 ` : `bottom-full`} transition-all`}>
